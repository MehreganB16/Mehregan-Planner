...
const priorityConfig: Record<Priority, { label: string; color: string; icon: React.ElementType, borderColor: string; checkboxColor: string }> = {
  urgent: { label: 'Urgent', color: 'bg-purple-600 text-white hover:bg-purple-700', icon: AlertTriangle, borderColor: 'border-purple-600', checkboxColor: 'border-purple-600' },
